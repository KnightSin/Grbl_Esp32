...
IntSetting* em_hold_value;      // [XBoard]
FlagSetting* em_invert;         // [XBoard]
FloatSetting* servo_max_angle;  // [XBoard]
FlagSetting* servo_invert;      // [XBoard]
...
enum_opt_t spindleTypes = {
    ...
    { "Servo", int8_t(SpindleType::Servo) },    // [XBoard]
    { "EM", int8_t(SpindleType::EM) },          // [XBoard]
    // clang-format on
};
...
void make_settings() {
    ...
    spindle_pwm_max_value =
        new FloatSetting(EXTENDED, WG, "36", "Spindle/PWM/Max", DEFAULT_SPINDLE_MAX_VALUE, 0.0, 1000.0, checkSpindleChange);
    spindle_pwm_min_value =
        new FloatSetting(EXTENDED, WG, "35", "Spindle/PWM/Min", DEFAULT_SPINDLE_MIN_VALUE, 0.0, 1000.0, checkSpindleChange);
    ...
    em_hold_value = new IntSetting(EXTENDED, WG, NULL, "Spindle/EM/Hold", 300, 0, 1024);            // [XBoard]
    em_invert = new FlagSetting(EXTENDED, WG, NULL, "Spindle/EM/Invert", 0);                        // [XBoard]
    servo_max_angle = new FloatSetting(EXTENDED, WG, NULL, "Spindle/Servo/MaxAngle", 90, 1, 180);   // [XBoard]
    servo_invert = new FlagSetting(EXTENDED, WG, NULL, "Spindle/Servo/Invert", 0);                  // [XBoard]
}
