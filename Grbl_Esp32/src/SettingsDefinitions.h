...
extern IntSetting* em_hold_value;      // [XBoard]
extern FlagSetting* em_invert;         // [XBoard]
extern FloatSetting* servo_max_angle;  // [XBoard]
extern FlagSetting* servo_invert;      // [XBoard]
